...
```{r}
clusters_output <- bisecting_kmeans(jaccard_dist, m = 5000, 15) # change last parameter to k value
```
...
anonymized_mat <- rownames_to_column(anonymized_v1, var = "userID")
